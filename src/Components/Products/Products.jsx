...
export default function Products() {
  ...
  return (
    ...
    <section className="products" ref={sectionRef}>
      <h2 className={`fade-up ${isVisible ? "visible" : ""}`}>
        <span className="blue">Totem</span> de atendimento
      </h2>
      <p className={`subtitle fade-up ${isVisible ? "visible" : ""}`}>
...
<br />
    <div class="custom-shape-divider-bottom-1760096562">
