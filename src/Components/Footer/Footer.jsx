    ...
    <footer className="footer">
      <div className="footer-container">
        ...
        <div className="footer-brand">
          <div className="footer-logo">TotSimple</div>
          <p className="footer-description">
           Somos a empresa TotSimple, o nosso produto é um serviço de autoatendimento inteligente
          </p>
          <div className="footer-copyright">
            Tot Simple 2025. All Rights Reserved.
          </div>
        </div>
        ...
        <div className="footer-column">
          ...
          <a href="#newsletter" className="footer-link">Email newsletter</a>
          <a href="#subscribe" className="footer-link">Subscribe</a>
        </div>
      </div>
      <div class="custom-shape-divider-top-1760887362">
